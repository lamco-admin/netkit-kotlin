...
class NetworkTypeProfiles(
     ...
     */
    fun getProfile(networkType: NetworkType): NetworkProfile? {
        return profiles[networkType]
    }
    ...
    fun matchProfile(
        ...
        return profiles.map { (type, profile) ->
            ProfileMatch(
                networkType = type,
                profile = profile,
    ...
    fun recommendProfile(
        ...
        return getProfile(requirements.networkType)
    }
    ...
    private fun calculateMatchScore(
        ...
        // Security match
        val securityMatches = profile.recommendedSecurity.any {
    ...
    companion object {
         ...
         */
        fun create(): NetworkTypeProfiles {
            return NetworkTypeProfiles(DEFAULT_PROFILES)
        }
    }
}
...
private val DEFAULT_PROFILES = mapOf(
    NetworkType.HOME_BASIC to NetworkProfile(
    ...
    NetworkType.HOME_ADVANCED to NetworkProfile(
    ...
    NetworkType.SMALL_OFFICE to NetworkProfile(
    ...
    NetworkType.ENTERPRISE to NetworkProfile(
    ...
    NetworkType.HIGH_DENSITY to NetworkProfile(
    ...
    NetworkType.GUEST_NETWORK to NetworkProfile(
    ...
    NetworkType.MESH_NETWORK to NetworkProfile(
