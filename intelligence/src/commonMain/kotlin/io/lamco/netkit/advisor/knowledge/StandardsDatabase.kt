...
class StandardsDatabase(
     ...
     */
    fun getStandardsByCategory(category: StandardCategory): List<StandardsReference> {
        return standards.filter { it.category == category }
    }
     ...
     */
    fun getStandard(id: String): StandardsReference? {
        return standards.find { it.id.equals(id, ignoreCase = true) }
    }
     ...
     */
    fun getWiFiStandards(): List<StandardsReference> {
        return getStandardsByCategory(StandardCategory.IEEE_WIFI)
    }

    /**
     * Get all security-related standards
     */
    fun getSecurityStandards(): List<StandardsReference> {
        return getStandardsByCategory(StandardCategory.SECURITY)
    }

    /**
     * Get compliance standards
     */
    fun getComplianceStandards(): List<StandardsReference> {
        return getStandardsByCategory(StandardCategory.COMPLIANCE)
    }
    ...
    fun getSummary(): StandardsDatabaseSummary {
        return StandardsDatabaseSummary(
            totalStandards = standards.size,
            byCategory = standards.groupBy { it.category }
    ...
    companion object {
         ...
         */
        fun create(): StandardsDatabase {
            return StandardsDatabase(DEFAULT_STANDARDS)
        }
    }
}
 ...
 */
private val DEFAULT_STANDARDS = listOf(
    // IEEE 802.11 WiFi Standards
    StandardsReference(
        id = "IEEE 802.11-2020",
        name = "IEEE Standard for Information Technology—Telecommunications and information exchange between systems Local and metropolitan area networks—Specific requirements - Part 11: Wireless LAN Medium Access Control (MAC) and Physical Layer (PHY) Specifications",
