...
class VendorSpecificKnowledgeBase(
     ...
     */
    fun getVendorKnowledge(vendor: RouterVendor): VendorKnowledge? = knowledgeBase[vendor]
     ...
     */
    fun getCriticalIssues(vendor: RouterVendor): List<VendorIssue> = getKnownIssues(vendor, minimumSeverity = IssueSeverity.CRITICAL)
     ...
     */
    fun getBestPractices(vendor: RouterVendor): List<String> = getVendorKnowledge(vendor)?.bestPractices ?: emptyList()
     ...
     */
    fun getOptimalSettings(vendor: RouterVendor): Map<String, String> = getVendorKnowledge(vendor)?.optimalSettings ?: emptyMap()
     ...
     */
    fun getVendorFeatures(vendor: RouterVendor): List<VendorFeature> = getVendorKnowledge(vendor)?.features ?: emptyList()
    ...
    companion object {
         ...
         */
        fun create(): VendorSpecificKnowledgeBase = VendorSpecificKnowledgeBase(DEFAULT_VENDOR_KNOWLEDGE)
    }
}
 ...
 */
private val DEFAULT_VENDOR_KNOWLEDGE =
    mapOf(
        RouterVendor.CISCO to
            VendorKnowledge(
                vendor = RouterVendor.CISCO,
                bestPractices =
                    listOf(
