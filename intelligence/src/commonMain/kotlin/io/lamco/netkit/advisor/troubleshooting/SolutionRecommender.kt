...
class SolutionRecommender {
    ...
    fun getAllSolutions(issue: NetworkIssue): List<SolutionRecommendation> {
        return SOLUTION_DATABASE[issue]?.sortedByDescending { it.impact.ordinal } ?: emptyList()
    }
    ...
    companion object {
         ...
         */
        private val SOLUTION_DATABASE = mapOf(
            ...
            NetworkIssue.INTERFERENCE to listOf(
                SolutionRecommendation(
            ...
            NetworkIssue.OUTDATED_FIRMWARE to listOf(
                SolutionRecommendation(
            ...
            NetworkIssue.INSUFFICIENT_COVERAGE to listOf(
                SolutionRecommendation(
            ...
            NetworkIssue.POOR_AP_PLACEMENT to listOf(
                SolutionRecommendation(
            ...
            NetworkIssue.CLIENT_ROAMING_FAILURE to listOf(
                SolutionRecommendation(
            ...
            NetworkIssue.ISP_ISSUE to listOf(
                SolutionRecommendation(
